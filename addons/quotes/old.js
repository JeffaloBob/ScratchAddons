    ...
    document.addEventListener("selectionchange", debounce(function (event) {
        ...
        if (document.getSelection().focusNode.parentElement.className == 'post_body_html') {
            ...
            if (selection == '') {
                ...
                if (document.getSelection().focusNode.parentElement.parentElement.parentElement.parentElement.parentElement.children[1]) {
                    username = document.getSelection().focusNode.parentElement.parentElement.parentElement.parentElement.parentElement.children[1].children[0].children[0].children[0].innerText
                }
...
export default async function ({ addon, global, console }) {
    ...
    quoteButton.addEventListener('click', e => {
        document.getElementById('id_body').scrollTo()
        textFieldEdit.insert(document.getElementById('id_body'), `[quote=${quoteButton.dataset.username}]${quoteButton.dataset.words}[/quote]`)
    })
