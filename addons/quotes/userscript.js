...
export default async function ({ addon, global, console }) {
  ...
  document.addEventListener(
    ...
    debounce(function (event) {
      ...
      if (document.getSelection().anchorNode.parentElement.className == "post_body_html") {
        //todo check if anchor node is the same as focus node
        ...
        if (selection == "") {
          ...
          if (
            document.getSelection().anchorNode.parentElement.parentElement.parentElement.parentElement.parentElement
              .children[1]
          ) {
            username = document.getSelection().anchorNode.parentElement.parentElement.parentElement.parentElement
